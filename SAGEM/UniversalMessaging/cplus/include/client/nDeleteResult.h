 ...
 *
 */
#ifndef NDELETERESULT_H
#define NDELETERESULT_H
...
class nDeleteResult : nResult {
  ...
  protected:
    nDeleteResult(nChannelAttributes* attr, bool _channel);

    nDeleteResult(nChannelAttributes* attr, nBaseClientException* exception);
  private:
    bool _isChannel;
};
}
