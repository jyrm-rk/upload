...
SET OSGI_INSTALL_AREA=C:\temp\SAGEM\profiles\SPM
...
SET WRAPPER="C:\temp\SAGEM\common\bin\wrapper-3.5.43.exe"
...
SET SERVICE_NAME=sagspm107_7.1
SET WINDOW_TITLE=Software AG Platform Manager 10.7 (7)
